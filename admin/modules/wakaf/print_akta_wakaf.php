...
/* Cetak Akta Ikrar Wakaf Buku , Oleh Muhammad Ibrahim */
...
if (isset($_POST['wakifID']) AND !empty($_POST['wakifID']) AND isset($_POST['itemAction'])) {
    ...
    foreach ($_POST['wakifID'] as $wakifID) {
        ...
        if (!empty($wakifID)) {
            ...
            echo '$.ajax({url: \''.SWB.'lib/phpbarcode/barcode.php?code='.$card_text.'&encoding='.$sysconf['barcode_encoding'].'&scale='.$size.'&mode=png\', type: \'GET\', error: function() { alert(\'Error creating Akta Ikrar Wakaf!\'); } });'."\n";
            // add to sessions
...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
    ...
    while ($wakif_d = $wakif_q->fetch_assoc()) {
        ...
        $html_str .= '<div class="bungkus">
                        <img src="'.$kopsurat_template.'" class="kop-surat">
                        <div class="isi">
                            <center>
                                <h2><u>AKTA IKRAR WAKAF</u></h2>
                            </center>
                            <br>
                            <table>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="62%">'.$wakif_d['wakif_name'].'</td>
                                </tr>
                                <tr>
                                    <td>Pekerjaan</td>
                                    <td align="center">:</td>
                                    <td>'.$wakif_d['pekerjaan'].'</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Tanggal</td>
                                    <td align="center">:</td>
                                    <td>'.tgl_indo(date_format($date, 'Y-m-d')).'</td>
                                </tr>
                                <tr>
                                    <td colspan="3"><br></td>
                                </tr>
                                <tr>
                                    <td colspan="3">Dengan ini mewakafkan buku milik saya sejumlah <b>'.$wakif_d['total_books'].' buku</b>, dengan total nilai <b>'.$wakif_d['nilai_books'].'</b>.</td>
                                </tr>
                                <tr>
                                    <td colspan="3"><br></td>
                                </tr>
                                <tr>
                                    <td colspan="3">Wakaf buku tersebut diurus oleh Perpustakaan yang diwakili oleh :</td>
                                </tr>
                                <tr>
                                    <td>Nama Lengkap</td>
                                    <td align="center">:</td>
                                ...
                                <tr>
                                    <td colspan="3">Demikian Ikrar Wakaf ini saya buat atas kehendak sendiri dan tanpa paksaan pihak lain.</td>
                                </tr>
                                <tr>
                                    <td colspan="3"><br></td>
                                </tr>
                            ...
                            <table>
                                <tr align="center">
                                    <td width="45%"></td>
                                    <td width="10%"></td>
                                    <td width="45%">Ponorogo, '.tgl_indo(date_format($date, 'Y-m-d')).'</td>
                                </tr>
                                <tr>
                                    <td colspan="3"><br></td>
                                </tr>
    ...
    if ($file_write) {
        ...
        echo '<script type="text/javascript">top.jQuery.colorbox({href: "'.SWB.FLS.'/'.$print_file_name.'", iframe: true, width: 800, height: 595, title: "'.__('Akta Ikrar Wakaf Buku : Muhammad Ibrahim').'"})</script>';
...
<div class="menuBoxInner printIcon">
    <div class="per_title">
        <h2><?php echo __('Akta Ikrar Wakaf Buku'); ?></h2>
    </div>
    <div class="sub_section">
        <div class="btn-group">
        <a target="blindSubmit" href="<?php echo MWB; ?>wakaf/print_akta_wakaf.php?action=clear" class="notAJAX btn btn-default" style="color: #f00;"><i class="glyphicon glyphicon-trash"></i>&nbsp;<?php echo __('Clear Print Queue'); ?></a>
        <a target="blindSubmit" href="<?php echo MWB; ?>wakaf/print_akta_wakaf.php?action=print" class="notAJAX btn btn-default"><i class="glyphicon glyphicon-print"></i>&nbsp;<?php echo __('Cetak Akta Wakaf'); ?></a>
    </div>
        <form name="search" action="<?php echo MWB; ?>wakaf/print_akta_wakaf.php" id="search" method="get" style="display: inline;"><?php echo __('Search'); ?>:
