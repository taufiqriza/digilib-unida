...
<div class="menuBoxInner loanRulesIcon">
    ...
    <div class="workspace-hero">
      ...
      <div class="workspace-hero__text">
        ...
        <p><?php echo __('Manage Lending Policies & Regulations'); ?></p>
      </div>
      <div class="workspace-hero__stats">
        <?php
        // Get total loan rules count
        $rules_count_q = $dbs->query("SELECT COUNT(*) FROM mst_loan_rules");
        $rules_count = $rules_count_q->fetch_row()[0];
        ?>
        <div class="workspace-stat">
          <div class="workspace-stat__value"><?php echo $rules_count; ?></div>
          <div class="workspace-stat__label"><?php echo __('Rules'); ?></div>
        </div>
      </div>
    </div>
    ...
    <div class="workspace-surface">
      <div class="workspace-section">
        <div class="workspace-section__header">
          <h3><i class="fas fa-list"></i> <?php echo __('Manage Loan Rules'); ?></h3>
          <p><?php echo __('Configure lending policies for different member types and collection types'); ?></p>
        </div>

        <div class="workspace-form-card">
          <div class="workspace-actions" style="margin-bottom: 16px;">
            <a href="<?php echo MWB; ?>circulation/loan_rules.php" class="workspace-btn workspace-btn--secondary">
              <i class="fas fa-list"></i>
              <span><?php echo __('Loan Rules List'); ?></span>
            </a>
            <a href="<?php echo MWB; ?>circulation/loan_rules.php?action=detail" class="workspace-btn workspace-btn--primary">
              <i class="fas fa-plus-circle"></i>
              <span><?php echo __('Add New Loan Rules'); ?></span>
            </a>
          </div>
...
$(document).ready(function() {
    ...
    $('#loanRulesSearchToggle').click(function(e) {
        e.preventDefault();
        $(this).toggleClass('collapsed');
        $('#loanRulesSearchContent').collapse('toggle');
