...
<div class="btn-group">
    <a href="fines_list.php?action=detail" class="btn btn-danger"><i class="fas fa-plus-circle"></i> <?php echo __('Add New Fines'); ?></a>
    <a href="fines_list.php" class="btn btn-default"><i class="fas fa-list"></i> <?php echo __('Fines List'); ?></a>
    <a href="fines_list.php?balance=true" class="btn btn-default"><i class="fas fa-check-circle"></i> <?php echo __('View Balanced Overdue'); ?></a>
</div>
</div>
<?php
/* search form end */
...
if ((isset($_GET['detail']) && isset($_GET['itemID'])) || (isset($_GET['action']) && $_GET['action'] == 'detail')) {
    ...
    echo '<div class="alert alert-danger"><strong><i class="fas fa-exclamation-triangle"></i> ' . __('Total of unpaid fines') . ': '.currency($total_unpaid_fines).'</strong></div>';
