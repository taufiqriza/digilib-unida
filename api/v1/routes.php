...
require __DIR__ . '/controllers/MyLibController.php';
...
$router->map('GET', '/mylib/popular', 'MyLibController@getPopular');
$router->map('GET', '/mylib/latest', 'MyLibController@getLatest');
$router->map('GET', '/mylib/subject',
'MyLibController@getPopularSubject');
$router->map('GET', '/mylib/top', 'MyLibController@getTopMember');
$router->map('GET', '/mylib/news', 'MyLibController@getNewsLatest');
